...
//    private Button inceptionQuant;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        packed = (Button) findViewById(R.id.predict_P);
        veggie = (Button) findViewById(R.id.predict_V);
        fruits = (Button) findViewById(R.id.predict_F);

        packed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                chosen_M = "model_P.tflite";
                chosen_L = "labels_P.txt";
                openCameraIntent();
            }
        });
        veggie.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                chosen_M = "model_V.tflite";
                chosen_L = "labels_V.txt";
                openCameraIntent();
        ...
        fruits.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                chosen_M = "model_F.tflite";
                chosen_L = "labels_F.txt";
                openCameraIntent();
            }
        });
...
//        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        // if cropping acitivty is finished, get the resulting cropped image uri and send it to 'Classify' activity
            ...
            // put modelname in extras
            i.putExtra("chosen_M", chosen_M);
            // put labelname in extras
            i.putExtra("chosen_L", chosen_L);
